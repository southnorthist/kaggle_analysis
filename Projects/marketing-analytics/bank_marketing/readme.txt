...
ordered by date (from May 2008 to November 2010), very close to the data 
...
4) bank.csv with 10% of the examples and 17 inputs, randomly selected from 
3 (older version of this dataset with less inputs).
...
should only be included for benchmark purposes and should be discarded if 
...
(Eds.), Proceedings of the European Simulation and Modelling Conference - 
ESM'2011, pp. 117-121, Guimaraes, Portugal, October, 2011. EUROSIS. 
[bank.zip]
